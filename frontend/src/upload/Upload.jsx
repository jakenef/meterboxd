...
const Upload = () => {
    ...
    return (
        <div className="d-flex justify-content-center align-items-center upload-container" style={{ overflow: "hidden"}}>
            <div
            ...
            >
                ...
                <div className="upload-area mb-4">
                    <label
                        htmlFor="zip-upload"
                        className={`modern-upload-btn w-100 ${loading ? 'loading' : ''} ${fileName ? 'uploaded' : ''}`}
